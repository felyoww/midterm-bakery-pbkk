    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Atherial Bakery</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Indulge in our best treats baked with love. Don't miss the chance to savor our fresh bread and signature cakes that will make every moment extra special!</p>
        ...
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Special <span class="text-blue-500"> For You
                </span> </h1>
            ...
            <p class="mb-12 text-base text-center text-gray-500">
              Experience our all-time favorite menu!
            </p>
          </div>
        </div>
...
=======
    {{-- hero section --}}
    <div class="w-full h-screen bg-gradient-to-r from-purple-400 to-cyan-200 py-40 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Grid -->
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Enter a world of fairy-tale flavors only at <span class="text-violet-600">Atherial Bakery</span>
                    </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">In a land where sugar and spice weave tales
                        of enchantment, our bakery invites you to taste the magic and discover a world beyond
                        imagination!</p>
