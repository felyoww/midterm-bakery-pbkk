    ...
    <div class="w-full  bg-gradient-to-r from-black to-rose-500 py-10 sm:px-6  mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Welcome to <span class="text-white">Atherial Bakery</span></h1>
              <p class="mt-3 text-lg text-white dark:text-white">Indulge in our best treats baked with love. Don't miss the chance to savor our fresh bread and signature cakes that will make every moment extra special!</p>
      
              <!-- Buttons -->
              <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-800 text-white hover:bg-yellow-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
                  Get started
        ...
        <div class="max-w-6xl px-4 mx-auto lg:py-4 md:px-6">
         ...
         <div class="max-w-6xl px-4 mx-auto lg:py-4 md:px-6">
            ...
            <div class="py-6 mb-6 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                "The elven berry tart was amazing! Sweet, tangy, and the shop’s fantasy vibe is so fun.
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                "Loved the wizard spellbook cake! Rich and delicious, but it sold out quickly. Worth the wait!
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
