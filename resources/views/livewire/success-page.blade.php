          ...
          <div>
              ...
              <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div class="w-full px-4 mb-4 md:w-1/4">
                      ...
                      <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">{{ Number::currency($order->grand_total, 'IDR') }}</p>
                  </div>
                  <div class="w-full px-4 mb-4 md:w-1/4">
                          ...
                          <div class="flex items-start justify-between w-full">
                              <div class="flex items-center justify-center space-x-2">
                                  ...
                                  <div class="flex flex-col items-center justify-start">
                                      <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">Your order has been shipped!</p>
                                      <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">We will send you tracking details soon.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
              ...
              <p class="px-4 mb-4 text-base text-gray-600 dark:text-gray-400">If you have any questions, please <a href="mailto:help@example.com" class="text-blue-600 underline dark:text-blue-400">contact us</a>.</p>
          </div>
      </div>
  </section>
</div>
